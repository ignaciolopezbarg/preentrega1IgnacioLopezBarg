...
function Ofertas() {
  return (
    <div>
      <h1>PAGINA EN PREPARACION SOLO SE VERIFICAN LOS ENLACES</h1>
      <h2>Se renderizaran aca las colecciones de Funkos discontinuadas</h2>
    </div>
  )
}
...
//   useEffect(() => {
//     fetch("/imagenes.json/category/sports")
//       .then((response) => {
//         if (!response.ok) {
...
//         <div
//           key={image.id}
//           className="m-2 flex flex-col items-center border-2 solid rounded-xl"
//         >
//           <img
//             src={`/img/${image.img}`}
//             alt={image.name}
